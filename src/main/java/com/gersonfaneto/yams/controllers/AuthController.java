...
public abstract class AuthController {
   ...
   *     <code>User</code>.
   * @throws UserTypeNotFoundException If the <code>userType</code> didn't match any of the ones
   *     declared under the <code>UserType</code> enumeration.
  ...
  public static User registerUser(
      User loggedUser, String userEmail, String userPassword, String userName, String userType)
    ...
    Technician newUser =
        new Technician(userEmail, userPassword, UserType.findByName(userType), userName);
   ...
   * @see UserType
   */
  public static User unregisterUser(User loggedUser, String userEmail)
