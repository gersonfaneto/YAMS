...
public abstract class StockController {
  ...
  /**
   * Searches for a <code>Component</code> given its ID and subtracts its
   * <code>amountInStock</code>, indicating that its going to be used in a <code>Service</code>.
   *
  ...
  /**
   * Process the information of a <code>PurchaseOrder</code> and creates/stores the
   * <code>Component</code> referred by it.
   *
