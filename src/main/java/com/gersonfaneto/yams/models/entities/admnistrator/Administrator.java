...
public class Administrator extends User {
  ...
  private Administrator(String userEmail, String userPassword, UserType userType,
      String administratorName) {
    super(userEmail, userPassword, userType);
    this.administratorName = administratorName;
  }

  public Administrator retrieveInstance(String userEmail, String userPassword, String administratorName) {
